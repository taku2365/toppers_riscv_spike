 ...
 *  ��Ū�ޤ��ϴ���Ū�������������ʤ�»���˴ؤ��Ƥ⡤������Ǥ�����ʤ���
 * 
 *  @(#) $Id: sifive-fe310.h 2246 2018-12-29 23:34:31Z roi $
 */
 ...
 */
#define MASKROM_MEM_ADDR        0x00001000 +0x81000000
#define TRAPVEC_TABLE_CTRL_ADDR 0x00001010 +0x81000000
#define OTP_MEM_ADDR            0x00020000 +0x81000000
#define CLINT_CTRL_ADDR         0x02000000 
#define PLIC_CTRL_ADDR          0x0C000000 +0x81000000
#define AON_CTRL_ADDR           0x10000000 +0x81000000
#define PRCI_CTRL_ADDR          0x10008000 +0x81000000
#define OTP_CTRL_ADDR           0x10010000 +0x81000000
#define GPIO_CTRL_ADDR          0x10012000 +0x81000000
#define UART0_CTRL_ADDR         0x10013000 +0x81000000
#define SPI0_CTRL_ADDR          0x10014000 +0x81000000
#define PWM0_CTRL_ADDR          0x10015000 +0x81000000
#define UART1_CTRL_ADDR         0x10023000 +0x81000000
#define SPI1_CTRL_ADDR          0x10024000 +0x81000000
#define PWM1_CTRL_ADDR          0x10025000 +0x81000000
#define SPI2_CTRL_ADDR          0x10034000 +0x81000000
#define PWM2_CTRL_ADDR          0x10035000 +0x81000000
#define SPI0_MEM_ADDR           0x20000000 +0x81000000
#define MEM_CTRL_ADDR           0x80000000 +0x81000000
